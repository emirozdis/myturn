...
export default function StreaksPage() {
  const stats = GROUP_STREAK_STATS["apt"];
  
  // State for the generative achievement modal
  ...
  return (
    <>
      ...
      `,
        ...
        {/* Demo trigger section for Achievement UI's */}
        <div style={glassStyle(0.04, 20, 0.08)} className="rounded-[24px] p-5 flex flex-col gap-3">
          ...
          {/* A horizontally scrollable list to accommodate many buttons gracefully */}
          <div 
      ...
      {/* Global Generative Achievement Overlay Renderer */}
      <AnimatePresence>
        {activeAchievement && (
          <AchievementOverlay
