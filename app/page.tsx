...
import { ArrowLeft, EyeOff, Eye, Camera, User, Loader2 } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col overflow-y-auto scrollbar-hide pb-8">
        ...
        <div className="w-full flex-shrink-0 mt-auto">
          ...
          <button 
            ...
            className={`w-full py-4 rounded-[18px] font-bold text-[16px] transition-all mb-4 flex items-center justify-center gap-2 ${
              code.length >= 4 
